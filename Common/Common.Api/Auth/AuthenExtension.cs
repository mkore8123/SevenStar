...
public static class AuthenExtension
{
    ...
    /// <returns></returns>
    public static IServiceCollection AddJwtTokenService<TUser, TTokenConfigProvider, TSigningKeyProvider, TClaimsMapper>(this IServiceCollection services)
    ...
    {
        services.AddSingleton<IJwtTokenConfigProvider<TUser>, TTokenConfigProvider>();
        services.AddSingleton<IJwtSigningKeyProvider, TSigningKeyProvider>();
        services.AddSingleton<IClaimsMapper<TUser>, TClaimsMapper>();
        services.AddSingleton<IMultiJwtValidationConfigProvider, JwtTokenService<TUser>>();
